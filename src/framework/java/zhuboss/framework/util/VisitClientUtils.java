/*
 * @(#)VisitClientUtils.java 1.0 2014-4-15上午09:37:54
 *
 * 和讯信息科技有限公司 - 第三方理财事业部
 ...
 * 
 */
public class VisitClientUtils {

	static Logger logger = LoggerFactory.getLogger(VisitClientUtils.class);
     ...
     */
     public static boolean isMobileDevice(HttpServletRequest request){
         ...
         logger.info("isMobileDevice.HttpServletRequest>>> via:"+via+", userAgent:"+userAgent);
         ...
         logger.info("mobileFlag:"+mobileFlag+", pcFlag:"+pcFlag+", >>>isMobileDevice:"+b);
     ...
     public static boolean isWeixin(HttpServletRequest request){
    	 boolean isWeixinFlag = false;
    	 String userAgent = request.getHeader("user-agent");
         logger.info("isWeixin.HttpServletRequest>>> userAgent:"+userAgent);
         ...
         logger.info("isWeixinFlag:"+isWeixinFlag);
         return isWeixinFlag;
     }
